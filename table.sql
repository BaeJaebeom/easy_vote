...
CREATE TABLE `vote_creation_option`
(
    `vote_creation_option_index` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '투표 선택 옵션 번호',
    ...
    PRIMARY KEY (`vote_creation_option_index`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
